...
const file_sso_proto_rawDesc = "" +
	...
	"\fRefreshToken\x12\x14.auth.RefreshRequest\x1a\x15.auth.RefreshResponseB\x14Z\x12tuzov.sso.v1;ssov1b\x06proto3"
...
var file_sso_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.RefreshToken:input_type -> auth.RefreshRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.RefreshToken:output_type -> auth.RefreshResponse
